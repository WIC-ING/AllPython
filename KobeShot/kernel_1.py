...
testdata = allData[allData['shot_made_flag'].isnull()].reset_index()
...
#%% create a new lable for shot difficulty model
...
#做了一手独热编码，完全可以用pd.get_dummies来替代
...
#------------------------------------------------------------------------------------------------------------
#-----------------Build a model based on featuresDB table, and make sure it doesn't over fit------------------
#------------------------------------------------------------------------------------------------------------
...
# print(mainLearner.feature_importances_.shape)
...
#
# print(featureImportance.iloc[:30, :])
